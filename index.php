  ...
  <body class="w3-theme-d4">
    <div class="w3-container">
      ...
      <div class="w3-bar w3-black">
        ...
        <button class="w3-bar-item w3-button tablink" onclick="openImg(event,'Archive')">Archive</button>
      </div>
      ...
      <div id="Archive" class="map w3-container w3-border w3-border-black w3-theme" style="display:none;">
      <ul class="w3-ul w3-hoverable w3-xlarge">
          <?php
            echo "<a href='/'><li>Latest</li></a>";
            for ($i = 0; $i < sizeof($files); $i++) {
